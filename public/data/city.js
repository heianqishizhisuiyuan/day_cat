...
function province(province){
		var domicile_province="";
		$.each(city, function(index,data) {
			domicile_province+="<option>"+data.name+"</option>";
		});
		$(domicile_province).appendTo($("#"+province));
	}
function areaa(cityy,areaa){
		if($("#"+cityy+" option:checked").text()){
			var domicile_area="";
			$.each(city, function(index,data) {
				$.each(data.city,function(index,data){
					if(data.name==$("#"+cityy+" option:checked").text()){
						$.each(data.area,function(index,data){
							domicile_area+="<option>"+data+"</option>";
						})
						$("#"+areaa).html("<option></option>")
						$(domicile_area).appendTo($("#"+areaa))
					}
				})
			})
		};
	...
	function cityyi(province,cityy){
		if($("#"+province+" option:checked").text()){
			var domicile_city="";
			$.each(city, function(index,data) {
				if(data.name==$("#"+province+" option:checked").text()){
					$.each(data.city,function(index,data){
						domicile_city+="<option>"+data.name+"</option>";
					})
				}
			});
			$("#"+cityy).html("<option> </option>");
			$(domicile_city).appendTo($("#"+cityy));
		}
	};